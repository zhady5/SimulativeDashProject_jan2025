...
#    return fig
    ...
    html = """ <style> #myTable { width: 100%; border-collapse: collapse; } #myTable th, #myTable td { padding: 8px 0 !important ; text-align: center; border: 1px solid black; color: #666; font-size: 12px; } .circle { display: inline-block; border-radius: 50%; text-align: center; } </style> """
