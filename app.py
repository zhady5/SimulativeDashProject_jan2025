...
def main():
    ...
    with col1:
        ...
        fig_subs = create_fig_subs_inds(subs, selected_channel, slider_fig_subs , bgcolor, word_color, contr_color, graph_color)
    ...
    with col2:
        ...
        st.pyplot(create_table_top5(posts, post_view, subs, gr_pvr,  selected_channel, bgcolor, word_color, cmap_colors), bbox_inches='tight')
